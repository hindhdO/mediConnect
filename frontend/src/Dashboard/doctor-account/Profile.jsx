     ...
     <form >
        ...
        <div className="mb-5">
            ...
            {formData.qualifications?.map((item,index)=><div key={index}>
                ...
                <button onClick={addQualification} className="bg-[#000] py-2 px-5 rounded text-white h-fit cursor-pointer">Add Quatlification</button>
        </div>
        <div className="mb-5">
        ...
        <div className="mb-5">
                ...
                <textarea name="about" rows={5} value={formData.about} placeholder="whrite about you" onChange={handleInputChange} className="form__input"></textarea>
        </div>
