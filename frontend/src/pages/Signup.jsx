...
const Signup = () => {
  ...
  const [previexURL,setPreviexURL]=useState("");
  ...
  const handleFileInputChange = async (e) => {
    ...
    console.log(file); // Log formData to console, replace with actual signup logic
  };
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          <div className="hidden lg:block bg-primaryColor rounded-l-lg">
            <figure className="rounded-l-lg">
              <img src={`${signupImg}?${key}`} alt="" className="w-full rounded-l-lg" />
            </figure>
          </div>
            ...
            <form onSubmit={submitHandler}>
              ...
              <div className="mb-5 flex items-center gap-3 ">
                ...
                <div className="relative w-[130px] h-[50px] " >
                  ...
                  items-center px-[0.75rem]  py-[0.37rem] text-[15px] leading-6 overflow-hidden bg-[#0066ff46]
                  text-headingColor font-semibold rounded-lg truncate cursor-pointer " >Upload Photo</label>
              ...
              <button 
                type="submit" 
                className='mt-7 w-full bg-primaryColor text-white text-[18px] leading-[30px] py-4 px-3 
